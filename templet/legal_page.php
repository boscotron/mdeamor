...
<div class="uk-section-default uk-section">
   <div class="uk-container">
      <div class="uk-grid-margin" uk-grid>
         <div class="uk-width-1-1@m">
            <div class="uk-margin">
               <h1 class="p1 jmy_web_div" data-tabla="<?php echo $table; ?>" data-page="<?php echo $page; ?>" id="titulo" data-editor="no"><?php $this->pnt('titulo','<span class="s1">&nbsp; Título del documento legal &nbsp; </span>'); ?></h1>
